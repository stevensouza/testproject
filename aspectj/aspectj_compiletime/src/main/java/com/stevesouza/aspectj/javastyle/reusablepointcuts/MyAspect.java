package com.stevesouza.aspectj.javastyle.reusablepointcuts;
...
public class MyAspect {
    ...
    @Before("within(MyClass) && com.stevesouza.aspectj.javastyle.reusablepointcuts.pointcuts.ReusablePointcuts.myOtherMethodPointcut()")
